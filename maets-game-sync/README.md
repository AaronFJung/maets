...
>
> **Protocol version:** `1` &nbsp;•&nbsp; **Package:** `@maets/game-sync` &nbsp;•&nbsp; **Transport:** Supabase Realtime
>
> Game plugins live in the sibling `@maets/games` package; React bindings
> (`useMatch`, `useLobby`) live in the consuming app.
...
```tsx
"use client";
import { ticTacToe, type TttState, type TttAction } from "@maets/games";
